...
#######################################################
def Setup_Enc():
    # Setup enclave supervisor code
    line = "# Enclave supervisor code\n"
    line += "li x5, 0x80480000\n"
    line += "li x6, 0x000012b7\n"
    line += "sw x6, 0(x5)\n"
    line += "li x6, 0x0092829b\n"
    line += "sw x6, 4(x5)\n"
    line += "li x6, 0x01329293\n"
    line += "sw x6, 8(x5)\n"
    line += "li x6, 0x50028293\n"
    line += "sw x6, 12(x5)\n"
    line += "li x6, 0x10529073\n"
    line += "sw x6, 16(x5)\n"
    line += "li x6, 0x10200072\n"
    line += "sw x6, 20(x5)\n"
    host_supervisor.append(line)

    # setup enclave supervisor trap entry code
    line = "# Enclave supervisor trap entry code\n"
    line += "li x5, 0x80480500\n"
    line += "li x6, 0x06a00893\n"
    line += "sh x6, 0(x5)\n"
    line += "li x6, 0x4505\n"
    line += "sh x6, 4(x5)\n"
    line += "li x6, 0x00000073\n"
    line += "sw x6, 6(x5)\n"
    host_supervisor.append(line)

    # setup enclave user code
    line = "# Enclave supervisor trap entry code\n"
    line += "li x5, 0x80480500\n"
    line += "li x6, 0x06a00893\n"
    line += "sh x6, 0(x5)\n"
...
def Create_Enc(start_addr = "0x80480000", size = "0x4000", utm_addr = "0x80488000",
               utm_size = "0x2000", runtime_addr = "0x80480000", user_addr = "0x80481000", 
               free_addr = "0x80482000", runtime_entry = "0x80480000", user_entry = "0x80481000",
...
def Fill_Enc_Mem(enc_addr = "0x80580020", secret = "0xdeadbeef", num_dwords = "150"):
  line = "# Enclave data\n"
  line += "li x4, " + num_dwords + "\n"
  line += "li x5, " + enc_addr + "\n"
  line += "li x6, " + secret + "\n"
  line += "looop:  sd x6, 0(x5)\n"
  line += "addi x4, x4, -1\n"
  line += "addi x5, x5, 8\n"
  line += "bnez x4, looop\n"
  host_supervisor.append(line)
...
def PK_VM_Init():
    line = ""
    line += "li sp, 0x80473000\n"
    line += "jal pk_vm_init\n"
    line += "jal set_trap_vector\n"
    host_supervisor.append(line)

def Exe_Enc(eid_ptr = 0x80475000):
    line = "# Run the first enclave\n"   
    line += "RUN_ENC:li a5, " + eid_ptr + "\n"
    line += "ld a5, 0(a5)\n"
    line += "mv a0, a5\n"
    line += "li a7, SBI_SM_RUN_ENCLAVE\n"
    line += "ecall\n"
    host_supervisor.append(line)
...
list_kernel_secrets = [0x88888888, 0x99999999, 0xaaaaaaaa, 0xbbbbbbbb, 0xcccccccc, 0xdddddddd, 0xeeeeeeee,
                            0xffffffffffffffff]
list_enclave_secrets = [0x88888888, 0x99999999, 0xaaaaaaaa, 0xbbbbbbbb, 0xcccccccc, 0xdddddddd, 0xeeeeeeee,
                            0xffffffffffffffff]
...
def Exp_Acc_Enc_L1(secret_addr = "0x80580020", secret_value = "0xdeadbeef"):
    ...
    line += "li a6, " + secret_addr + "\n"
    line += "li a5, 0x80480010\n" 
